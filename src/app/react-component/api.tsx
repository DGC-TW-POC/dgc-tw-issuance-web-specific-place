...
import * as MedicalProducts from './assets/json-res/vaccine-medicinal-product.json';
import * as DiseaseAgents from './assets/json-res/disease-agent-targeted.json';
import * as VaccineManufacturers from './assets/json-res/vaccine-mah-manf.json';
import * as Vaccines from './assets/json-res/vaccine-prophylaxis.json';
import * as TestManufacturers from './assets/json-res/test-manf.json';
import * as TestResult from './assets/json-res/test-result.json';
import * as TestType from './assets/json-res/test-type.json';
